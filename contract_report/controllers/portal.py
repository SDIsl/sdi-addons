...
class CustomerPortal(CustomerPortal):
    ...
    def portal_order_page(
        ...
        if order_sudo:
            ...
            if session_obj_date != now and request.env.user.share \
                    and access_token:
        ...
        if order_sudo.has_to_be_paid():
            partner_id = order_sudo.partner_id
            domain = expression.AND([
                ...
                ['|',
                    ...
                    ('country_ids', 'in', [partner_id.country_id.id])]
            ])
    ...
    def portal_quote_accept(
        ...
        sale_action_report = request.env.ref('sale.action_report_saleorder')
        pdf = sale_action_report.sudo().render_qweb_pdf([order_sudo.id])[0]
        _message_post_helper(
            res_model='sale.order',
            res_id=order_sudo.id,
