...
class ActivityPlanning(models.Model):
    ...
    recurrent = fields.Selection([('0', 'Daily'),
        ('1', 'Weekly'),('2', 'Monthly'),('3', 'Days of week')
        ], default='0', index=True, string="Frequency")
                    ...
                    for user in task.user_ids:
                        ...
                        if (not leave):
                            ...
                            for activity in activities:
                                ...
                                if (activity.depend_before==True and activity_id):
...
class CronActivityTemplate(models.Model):
    ...
    res_id = fields.Many2one('activity.planning', string="Cron Task Reference", required=True, ondelete='cascade',
